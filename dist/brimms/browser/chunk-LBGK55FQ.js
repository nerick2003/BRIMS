...
} from "./chunk-TA3IHDWY.js";
import "./chunk-DBGBYJNX.js";
import "./chunk-BBACT52E.js";
...
function RequestDetailComponent_Conditional_1_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275conditionalCreate(5, RequestDetailComponent_Conditional_1_Conditional_54_Conditional_5_Template, 3, 4, "span", 14);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function RequestDetailComponent_Conditional_1_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(3, "span", 13);
    \u0275\u0275text(4);
    \u0275\u0275conditionalCreate(5, RequestDetailComponent_Conditional_1_Conditional_55_Conditional_5_Template, 3, 4, "span", 14);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function RequestDetailComponent_Conditional_1_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RequestDetailComponent_Conditional_1_Conditional_61_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function RequestDetailComponent_Conditional_1_Conditional_61_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function RequestDetailComponent_Conditional_1_Conditional_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RequestDetailComponent_Conditional_1_Conditional_62_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function RequestDetailComponent_Conditional_1_Conditional_62_Template_button_click_55_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function RequestDetailComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(53);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(54, RequestDetailComponent_Conditional_1_Conditional_54_Template, 6, 2, "div", 11);
    \u0275\u0275conditionalCreate(55, RequestDetailComponent_Conditional_1_Conditional_55_Template, 6, 2, "div", 11);
    ...
    \u0275\u0275text(60);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(61, RequestDetailComponent_Conditional_1_Conditional_61_Template, 8, 0, "div", 20);
    \u0275\u0275conditionalCreate(62, RequestDetailComponent_Conditional_1_Conditional_62_Template, 60, 7, "section", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(14, _c1, ctx_r1.request.status === "Approved", ctx_r1.request.status === "Pending" || ctx_r1.request.status === "For Review" || ctx_r1.request.status === "Rejected"));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.request.status === "Pending" || ctx_r1.request.status === "For Review" ? 61 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.canDownload() ? 62 : -1);
  }
}
...
var RequestDetailComponent = class _RequestDetailComponent {
  constructor(route, data, qrCodeService, certificateGenerator, auth) {
    this.route = route;
    this.data = data;
  ...
  static {
    this.\u0275fac = function RequestDetailComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _RequestDetailComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(QrCodeService), \u0275\u0275directiveInject(CertificateGeneratorService), \u0275\u0275directiveInject(AuthService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RequestDetailComponent, selectors: [["app-request-detail"]], viewQuery: function RequestDetailComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(1, RequestDetailComponent_Conditional_1_Template, 63, 17, "div", 2)(2, RequestDetailComponent_Conditional_2_Template, 10, 0, "div", 2);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
`, styles: ['/* src/app/pages/request-detail/request-detail.component.scss */\n.request-detail .request-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 2rem;\n  gap: 1rem;\n  position: relative;\n  padding-right: 140px;\n}\n.request-detail .request-header .page-title {\n  margin-bottom: 0;\n}\n.request-detail .request-header .back-button {\n  position: absolute;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n@media (max-width: 640px) {\n  .request-detail .request-header {\n    flex-direction: column;\n    align-items: stretch;\n    padding-right: 0;\n  }\n  .request-detail .request-header .page-title {\n    margin-bottom: 1rem;\n  }\n  .request-detail .request-header .back-button {\n    position: static;\n    transform: none;\n  }\n}\n.request-detail .back-button {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 0.625rem 1.25rem;\n  color: var(--color-text);\n  text-decoration: none;\n  font-weight: 500;\n  font-size: 0.9375rem;\n  border-radius: var(--radius);\n  transition: all 0.2s ease;\n  width: fit-content;\n  background: var(--color-bg);\n  border: 1px solid var(--color-border);\n  white-space: nowrap;\n}\n.request-detail .back-button:hover {\n  background: var(--color-bg-card);\n  border-color: var(--color-primary);\n  color: var(--color-primary);\n  transform: translateX(-2px);\n  box-shadow: var(--shadow);\n}\n.request-detail .back-button:active {\n  transform: translateX(-1px);\n}\n.request-detail .back-button__icon {\n  font-size: 1.125rem;\n  line-height: 1;\n  transition: transform 0.2s ease;\n}\n.request-detail .back-button:hover .request-detail .back-button__icon {\n  transform: translateX(-2px);\n}\n.request-detail .back-button__text {\n  line-height: 1.5;\n}\n@media (max-width: 640px) {\n  .request-detail .back-button {\n    width: 100%;\n    justify-content: center;\n  }\n}\n.request-detail .request-info .info-section {\n  margin-bottom: 2rem;\n}\n.request-detail .request-info .info-section h2 {\n  margin-bottom: 1rem;\n  color: var(--color-text);\n  font-size: 1.25rem;\n}\n.request-detail .request-info .info-section .info-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 1rem;\n}\n.request-detail .request-info .info-section .info-grid .info-item {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n.request-detail .request-info .info-section .info-grid .info-item .info-label {\n  font-weight: 600;\n  color: var(--color-text-muted);\n  font-size: 0.875rem;\n}\n.request-detail .request-info .info-section .info-grid .info-item .info-value {\n  color: var(--color-text);\n  font-size: 1rem;\n}\n.request-detail .request-info .info-section .info-grid .info-item.qr-code-item {\n  grid-column: 1/-1;\n}\n.request-detail .request-info .info-section .info-grid .info-item.qr-code-item .qr-code-controls {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.request-detail .request-info .info-section .info-grid .info-item.qr-code-item .qr-code-controls .qr-code-display {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 1.5rem;\n  background: var(--color-bg);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--color-border);\n}\n.request-detail .request-info .info-section .info-grid .info-item.qr-code-item .qr-code-controls .qr-code-display .qr-code-image {\n  width: 200px;\n  height: 200px;\n  border: 4px solid var(--color-bg-card);\n  border-radius: var(--radius);\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n  background: var(--color-bg-card);\n  padding: 8px;\n}\n.request-detail .request-info .info-section .info-grid .info-item.qr-code-item .qr-code-controls .qr-code-display .qr-code-label {\n  margin: 0;\n  font-size: 0.875rem;\n  color: var(--color-text-muted);\n  text-align: center;\n  max-width: 300px;\n}\n.request-detail .request-info .action-section {\n  margin-top: 2rem;\n  padding-top: 2rem;\n  border-top: 1px solid var(--color-border);\n}\n.request-detail .request-info .action-section h2 {\n  margin-bottom: 1rem;\n  color: var(--color-text);\n  font-size: 1.25rem;\n}\n.request-detail .request-info .action-section .action-buttons {\n  display: flex;\n  gap: 1rem;\n}\n.request-detail .request-info .certificate-section {\n  margin-top: 2rem;\n}\n.request-detail .request-info .certificate-section__title {\n  font-size: 1.25rem;\n  font-weight: 600;\n  margin: 0 0 0.25rem;\n  color: var(--color-text);\n}\n.request-detail .request-info .certificate-section__hint {\n  margin: 0 0 1.5rem;\n  font-size: 0.875rem;\n  color: var(--color-text-muted);\n}\n.request-detail .request-info .certificate {\n  margin: 0 auto 2rem;\n  max-width: 720px;\n  aspect-ratio: 210/297;\n  padding: 2.5rem 2.75rem;\n  border: none;\n  border-radius: 12px;\n  background: #ffffff;\n  box-shadow: 0 10px 30px rgba(15, 23, 42, 0.15);\n  box-sizing: border-box;\n  color: #111827;\n  font-family:\n    "Times New Roman",\n    Georgia,\n    "Noto Serif",\n    serif;\n}\n.request-detail .request-info .certificate__header {\n  text-align: center;\n  margin-bottom: 2rem;\n}\n.request-detail .request-info .certificate__republic {\n  font-size: 0.9rem;\n  text-transform: uppercase;\n  letter-spacing: 0.12em;\n}\n.request-detail .request-info .certificate__province,\n.request-detail .request-info .certificate__municipality {\n  font-size: 0.95rem;\n  text-transform: uppercase;\n  letter-spacing: 0.16em;\n}\n.request-detail .request-info .certificate__barangay {\n  margin-top: 0.35rem;\n  font-size: 1.3rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.18em;\n}\n.request-detail .request-info .certificate__line {\n  width: 70%;\n  height: 1px;\n  margin: 0.6rem auto 0.4rem;\n  background: #111827;\n}\n.request-detail .request-info .certificate__office {\n  font-size: 0.9rem;\n  font-weight: 600;\n  letter-spacing: 0.14em;\n}\n.request-detail .request-info .certificate__body {\n  margin-top: 2.25rem;\n}\n.request-detail .request-info .certificate__title {\n  text-align: center;\n  font-size: 1.9rem;\n  letter-spacing: 0.16em;\n  text-transform: uppercase;\n  margin: 0 0 2.25rem;\n  font-weight: 700;\n}\n.request-detail .request-info .certificate__intro {\n  font-size: 1rem;\n  font-weight: 600;\n  text-align: left;\n  margin-bottom: 1.5rem;\n}\n.request-detail .request-info .certificate__paragraph {\n  font-size: 0.98rem;\n  line-height: 1.9;\n  text-align: justify;\n  margin-bottom: 1.4rem;\n  text-indent: 2.25rem;\n}\n.request-detail .request-info .certificate__highlight {\n  font-weight: 700;\n  text-transform: uppercase;\n}\n.request-detail .request-info .certificate__footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-end;\n  margin-top: 4rem;\n  gap: 2rem;\n}\n.request-detail .request-info .certificate__control {\n  font-size: 0.9rem;\n}\n.request-detail .request-info .certificate__control-label {\n  font-weight: 600;\n}\n.request-detail .request-info .certificate__control-value {\n  font-family: "Courier New", monospace;\n  margin-left: 0.25rem;\n}\n.request-detail .request-info .certificate__signature-block {\n  text-align: center;\n  min-width: 200px;\n}\n.request-detail .request-info .certificate__signature-line {\n  width: 100%;\n  border-bottom: 1px solid #111827;\n  margin-bottom: 0.35rem;\n}\n.request-detail .request-info .certificate__signature-name {\n  font-size: 0.9rem;\n  font-weight: 600;\n  text-transform: uppercase;\n}\n.request-detail .request-info .certificate-actions {\n  display: flex;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\n.request-detail .request-info .certificate-actions .btn {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.request-detail .request-info .certificate-actions .btn--lg {\n  padding: 0.875rem 1.5rem;\n  font-size: 1rem;\n}\n.request-detail .request-info .certificate-actions .btn .btn-icon {\n  font-size: 1.125rem;\n  line-height: 1;\n}\n/*# sourceMappingURL=request-detail.component.css.map */\n'] }]
  }], () => [{ type: ActivatedRoute }, { type: DataService }, { type: QrCodeService }, { type: CertificateGeneratorService }, { type: AuthService }], { certificateRef: [{
    type: ViewChild,
    args: ["certificateRef"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RequestDetailComponent, { className: "RequestDetailComponent", filePath: "src/app/pages/request-detail/request-detail.component.ts", lineNumber: 16 });
})();
export {
  RequestDetailComponent
};
//# sourceMappingURL=chunk-LBGK55FQ.js.map
