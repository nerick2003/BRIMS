...
function UsersRolesComponent_div_11_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(34, UsersRolesComponent_div_11_div_21_For_35_Template, 2, 2, "option", 36, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(36, UsersRolesComponent_div_11_div_21_div_36_Template, 8, 1, "div", 37);
    \u0275\u0275elementStart(37, "div", 29)(38, "label");
    \u0275\u0275text(39, "Status");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(46, UsersRolesComponent_div_11_div_21_p_46_Template, 2, 1, "p", 39);
    \u0275\u0275element(47, "span", 40);
...
function UsersRolesComponent_div_11_For_44_button_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 50);
    \u0275\u0275listener("click", function UsersRolesComponent_div_11_For_44_button_23_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const user_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.archiveUser(user_r7));
    });
    \u0275\u0275text(1, " Archive ");
    \u0275\u0275elementEnd();
  }
...
function UsersRolesComponent_div_11_For_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "td")(9, "select", 45);
    ...
    \u0275\u0275repeaterCreate(10, UsersRolesComponent_div_11_For_44_For_11_Template, 2, 2, "option", 36, _forTrack0);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td")(20, "div", 47)(21, "button", 48);
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275template(23, UsersRolesComponent_div_11_For_44_button_23_Template, 2, 0, "button", 49);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r7.role === "Admin" || user_r7.role === "Staff");
  }
}
...
function UsersRolesComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(22, "div", 22)(23, "table", 23)(24, "thead")(25, "tr")(26, "th");
    ...
    \u0275\u0275repeaterCreate(43, UsersRolesComponent_div_11_For_44_Template, 24, 10, "tr", null, _forTrack0, false, UsersRolesComponent_div_11_ForEmpty_45_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UsersRolesComponent_div_12_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 54)(1, "div", 55)(2, "div")(3, "h3");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 58)(10, "h4");
    \u0275\u0275text(11, "Permissions:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "ul", 59);
...
function UsersRolesComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, UsersRolesComponent_div_12_For_3_Template, 18, 4, "div", 54, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UsersRolesComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 64)(3, "h2", 65);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 69)(11, "div", 70)(12, "h3", 71);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 75)(23, "div", 76)(24, "div")(25, "h3", 71);
    \u0275\u0275text(26, "Permissions");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "p", 77);
    \u0275\u0275text(28, " Define what this role is allowed to do in the system. ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, UsersRolesComponent_Conditional_13_span_29_Template, 2, 2, "span", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 29)(31, "div", 79);
    \u0275\u0275repeaterCreate(32, UsersRolesComponent_Conditional_13_For_33_Template, 4, 1, "span", 80, \u0275\u0275repeaterTrackByIdentity, false, UsersRolesComponent_Conditional_13_ForEmpty_34_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 81)(36, "input", 82);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UsersRolesComponent, selectors: [["app-users-roles"]], decls: 14, vars: 11, consts: [[1, "users-roles-page"], [1, "page-header"], [1, "page-title"], [1, "tabs-wrapper"], ["role", "tablist", 1, "tabs"], ["type", "button", "role", "tab", 1, "tab-button", 3, "click"], [1, "tab-content"], ["class", "users-tab", 4, "ngIf"], ["class", "roles-tab", 4, "ngIf"], [1, "modal-overlay", 3, "modal-overlay--closing"], [1, "users-tab"], [1, "filters", "filters--with-action"], ["type", "text", "placeholder", "Search by Name or Email", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], ["value", "Admin"], ["value", "Staff"], ["value", "Resident"], ["value", "Active"], ["value", "Inactive"], ["type", "button", 1, "btn", "btn--primary", 3, "click"], ["class", "card add-user-card", 4, "ngIf"], [1, "table-wrap", "card"], [1, "table"], ["type", "checkbox"], [1, "card", "add-user-card"], [1, "add-user-header"], [1, "muted"], [1, "add-user-grid"], [1, "form-group"], [1, "required"], ["type", "text", "placeholder", "Enter first name", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "optional"], ["type", "text", "placeholder", "Enter middle name", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "Enter last name", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "email", "placeholder", "name@example.com", 1, "form-control", 3, "ngModelChange", "ngModel"], [3, "value"], ["class", "form-group", 4, "ngIf"], [1, "add-user-footer"], ["class", "error-text", 4, "ngIf"], [1, "spacer"], ["type", "button", 1, "btn", "btn--outline", "btn--sm", 3, "click"], ["type", "button", 1, "btn", "btn--primary", "btn--sm", 3, "click"], ["type", "password", "placeholder", "Login password for this user", "autocomplete", "new-password", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "error-text"], [1, "role-select", 3, "ngModelChange", "ngModel"], [1, "badge", 3, "ngClass"], [1, "user-actions"], ["type", "button", 1, "btn", "btn--sm", 3, "click", "ngClass"], ["type", "button", "class", "btn btn--sm btn--outline", "title", "Archive user", 3, "click", 4, "ngIf"], ["type", "button", "title", "Archive user", 1, "btn", "btn--sm", "btn--outline", 3, "click"], ["colspan", "8", 2, "text-align", "center", "padding", "2rem", "color", "var(--color-text-muted)"], [1, "roles-tab"], [1, "roles-grid"], [1, "role-card", "card"], [1, "role-header"], [1, "role-description"], [1, "badge", "badge--info"], [1, "permissions"], [1, "permissions-list"], [1, "role-actions"], ["type", "button", 1, "btn", "btn--outline", "role-edit-btn", 3, "click"], [1, "modal-overlay", 3, "click"], [1, "modal", "card", 3, "click"], [1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "modal-close", 3, "click"], [1, "modal-body", 3, "ngSubmit"], [1, "muted", "modal-desc"], [1, "modal-layout"], [1, "modal-section"], [1, "modal-section-title"], ["type", "text", "disabled", "", 1, "form-control", 3, "value"], [1, "form-group", "form-group--description"], ["rows", "4", "name", "roleDescription", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-section", "modal-section--permissions"], [1, "modal-section-header"], [1, "modal-section-subtitle", "muted"], ["class", "badge badge--info", 4, "ngIf"], [1, "permissions-tags", "permissions-tags--boxed"], [1, "permission-tag"], [1, "form-group", "permissions-add"], ["type", "text", "placeholder", "Enter permission then press Add", "name", "newPermission", 1, "form-control", 3, "ngModelChange", "keyup.enter", "ngModel"], ["type", "button", 1, "btn", "btn--sm", "btn--outline", 3, "click"], [1, "modal-actions"], ["type", "button", 1, "btn", "btn--outline", 3, "click"], ["type", "submit", 1, "btn", "btn--primary"], ["type", "button", 1, "permission-remove", 3, "click"]], template: function UsersRolesComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(11, UsersRolesComponent_div_11_Template, 46, 5, "div", 7)(12, UsersRolesComponent_div_12_Template, 4, 0, "div", 8);
        \u0275\u0275elementEnd();
                ...
                <td>\r
                  <div class="user-actions">\r
                    ...
                    <button\r
                      ...
                      *ngIf="user.role === 'Admin' || user.role === 'Staff'"\r
                      (click)="archiveUser(user)"\r
                      title="Archive user"\r
                    >\r
                      Archive\r
                    </button>\r
                  </div>\r
...
//# sourceMappingURL=chunk-JOMOE43N.js.map
