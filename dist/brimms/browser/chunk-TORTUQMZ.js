...
function ResidentLayoutComponent_For_10_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ResidentLayoutComponent_For_10_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ResidentLayoutComponent_For_10_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 26);
    \u0275\u0275element(1, "rect", 34)(2, "path", 35)(3, "path", 36);
    \u0275\u0275elementEnd();
  }
}
function ResidentLayoutComponent_For_10_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 26);
    \u0275\u0275element(1, "path", 37);
...
function ResidentLayoutComponent_For_10_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 26);
    \u0275\u0275element(1, "rect", 34)(2, "path", 38);
    \u0275\u0275elementEnd();
  }
}
function ResidentLayoutComponent_For_10_Case_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ResidentLayoutComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 23);
    \u0275\u0275listener("click", function ResidentLayoutComponent_For_10_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeMobileMenu());
    });
    \u0275\u0275elementStart(1, "span", 24);
    \u0275\u0275conditionalCreate(2, ResidentLayoutComponent_For_10_Case_2_Template, 5, 0, ":svg:svg", 25)(3, ResidentLayoutComponent_For_10_Case_3_Template, 3, 0, ":svg:svg", 26)(4, ResidentLayoutComponent_For_10_Case_4_Template, 4, 0, ":svg:svg", 26)(5, ResidentLayoutComponent_For_10_Case_5_Template, 2, 0, ":svg:svg", 26)(6, ResidentLayoutComponent_For_10_Case_6_Template, 3, 0, ":svg:svg", 26)(7, ResidentLayoutComponent_For_10_Case_7_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
...
function ResidentLayoutComponent_Conditional_23_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ResidentLayoutComponent_Conditional_23_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 42);
    \u0275\u0275element(1, "path", 51);
...
function ResidentLayoutComponent_Conditional_23_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 46);
  }
  if (rf & 2) {
...
function ResidentLayoutComponent_Conditional_23_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function ResidentLayoutComponent_Conditional_23_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 48)(1, "a", 52);
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Conditional_13_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r7);
    ...
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Conditional_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.logout();
      return \u0275\u0275resetView(ctx_r1.closeProfileMenu());
...
function ResidentLayoutComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "header", 39)(1, "h1", 40);
    \u0275\u0275text(2, "Barangay Resident Information System");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 41);
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.theme.toggleTheme());
    });
    \u0275\u0275conditionalCreate(4, ResidentLayoutComponent_Conditional_23_Conditional_4_Template, 3, 0, ":svg:svg", 42)(5, ResidentLayoutComponent_Conditional_23_Conditional_5_Template, 2, 0, ":svg:svg", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "div", 43);
    \u0275\u0275elementStart(7, "div", 44, 1)(9, "button", 45);
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleProfileMenu());
    });
    \u0275\u0275conditionalCreate(10, ResidentLayoutComponent_Conditional_23_Conditional_10_Template, 1, 1, "img", 46);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275conditionalBranchCreate(12, ResidentLayoutComponent_Conditional_23_Conditional_12_Template, 2, 0, "span", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, ResidentLayoutComponent_Conditional_23_Conditional_13_Template, 9, 2, "div", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_8_0;
...
function ResidentLayoutComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 55)(1, "span", 56);
    \u0275\u0275text(2, "+");
    \u0275\u0275elementEnd();
...
function ResidentLayoutComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResidentLayoutComponent, selectors: [["app-resident-layout"]], viewQuery: function ResidentLayoutComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function ResidentLayoutComponent_Template_button_click_6_listener() {
          return ctx.closeMobileMenu();
        });
        \u0275\u0275text(7, " \u2715 ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "nav", 9);
        \u0275\u0275repeaterCreate(9, ResidentLayoutComponent_For_10_Template, 10, 6, "a", 10, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("scroll", function ResidentLayoutComponent_Template_main_scroll_20_listener() {
          return ctx.onContentScroll();
        });
        \u0275\u0275element(22, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(23, ResidentLayoutComponent_Conditional_23_Template, 14, 10, "header", 17);
        \u0275\u0275conditionalCreate(24, ResidentLayoutComponent_Conditional_24_Template, 5, 5, "a", 18);
        \u0275\u0275conditionalCreate(25, ResidentLayoutComponent_Conditional_25_Template, 3, 2, "button", 19);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_9_0;
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(15, 10, ctx.currentTime, "h:mm:ss a"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(18, 13, ctx.currentTime, "EEEE, MMMM d, y"));
        \u0275\u0275advance(6);
        \u0275\u0275conditional(ctx.showTopRightUi ? 23 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_9_0 = ctx.fabLink) ? 24 : -1, tmp_9_0);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ResidentLayoutComponent, [{
    type: Component,
    args: [{ selector: "app-resident-layout", standalone: true, imports: [CommonModule, RouterOutlet, RouterLink, RouterLinkActive, DatePipe], template: `<div class="resident-layout">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResidentLayoutComponent, { className: "ResidentLayoutComponent", filePath: "src/app/layouts/resident-layout/resident-layout.component.ts", lineNumber: 17 });
})();
export {
  ResidentLayoutComponent
};
//# sourceMappingURL=chunk-TORTUQMZ.js.map
