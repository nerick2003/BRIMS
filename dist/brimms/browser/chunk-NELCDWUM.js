...
var ResidentProfileComponent = class _ResidentProfileComponent {
  constructor(route, router, data, qrCodeService) {
    this.route = route;
    this.router = router;
    this.data = data;
  ...
  static {
    this.\u0275fac = function ResidentProfileComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ResidentProfileComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(QrCodeService));
    };
  }
  static {
...
`, styles: ['/* src/app/pages/resident-profile/resident-profile.component.scss */\n.resident-profile {\n  width: 100%;\n  position: relative;\n}\n.page-header {\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  margin-bottom: 1rem;\n  gap: 1rem;\n}\n.page-header__right {\n  position: absolute;\n  top: 0;\n  right: 0;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n}\n.page-header .page-title {\n  margin: 0;\n  font-size: 1.5rem;\n  font-weight: 600;\n  padding-right: 200px;\n}\n@media (max-width: 640px) {\n  .page-header {\n    flex-direction: column;\n    align-items: stretch;\n    position: static;\n  }\n  .page-header__right {\n    width: 100%;\n    position: static;\n    flex-direction: column;\n    gap: 0.75rem;\n  }\n  .page-header .page-title {\n    margin-bottom: 0.75rem;\n    padding-right: 0;\n  }\n}\n.back-button {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 0.625rem 1.25rem;\n  color: var(--color-text);\n  text-decoration: none;\n  font-weight: 500;\n  font-size: 0.9375rem;\n  border-radius: var(--radius);\n  transition: all 0.2s ease;\n  width: fit-content;\n  background: var(--color-bg);\n  border: 1px solid var(--color-border);\n  white-space: nowrap;\n}\n.back-button:hover {\n  background: var(--color-bg-card);\n  border-color: var(--color-primary);\n  color: var(--color-primary);\n  transform: translateX(-2px);\n  box-shadow: var(--shadow);\n}\n.back-button:active {\n  transform: translateX(-1px);\n}\n.back-button__icon {\n  font-size: 1.125rem;\n  line-height: 1;\n  transition: transform 0.2s ease;\n}\n.back-button:hover .back-button__icon {\n  transform: translateX(-2px);\n}\n.back-button__text {\n  line-height: 1.5;\n}\n@media (max-width: 640px) {\n  .back-button {\n    width: 100%;\n    justify-content: center;\n  }\n}\n.tabs {\n  display: flex;\n  gap: 0;\n  margin-bottom: 1rem;\n  padding: 8px;\n  background: var(--color-bg-secondary);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--color-border);\n}\n.tabs button {\n  flex: 1;\n  min-width: 0;\n  padding: 12px 24px;\n  border: none;\n  background: transparent;\n  border-radius: var(--radius);\n  font-size: 0.9375rem;\n  font-weight: 500;\n  color: var(--color-text-muted);\n  cursor: pointer;\n  transition:\n    color 0.2s ease,\n    background 0.2s ease,\n    box-shadow 0.2s ease;\n  white-space: nowrap;\n}\n.tabs button:hover:not(.active) {\n  color: var(--color-text);\n}\n.tabs button.active {\n  color: white;\n  background: var(--color-primary);\n  box-shadow: 0 2px 8px color-mix(in srgb, var(--color-primary) 40%, transparent);\n}\n.profile-top {\n  display: flex;\n  gap: 1.5rem;\n  flex-wrap: wrap;\n}\n.avatar-lg {\n  width: 100px;\n  height: 100px;\n  border-radius: 50%;\n  background: var(--color-border);\n  flex-shrink: 0;\n  overflow: hidden;\n  position: relative;\n}\n.avatar-lg.avatar-lg--has-photo {\n  background: transparent;\n}\n.avatar-lg__img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  object-position: center 28%;\n  display: block;\n}\n.profile-info {\n  flex: 1;\n  min-width: 200px;\n}\n.profile-info .resident-id {\n  color: var(--color-text-muted);\n  font-size: 0.875rem;\n  margin: 0 0 4px;\n}\n.profile-info .resident-name {\n  font-size: 1.25rem;\n  margin: 0 0 0.75rem;\n}\n.profile-info .detail {\n  margin: 0.5rem 0;\n  font-size: 0.9375rem;\n}\n.profile-info .detail.highlight {\n  background: var(--color-bg-secondary);\n  color: var(--color-text);\n  padding: 0.75rem 1rem;\n  border-radius: 6px;\n  border-left: 3px solid var(--color-primary);\n  margin: 1rem 0;\n}\n.profile-info .detail.highlight .certificate-ref {\n  font-family: "Courier New", monospace;\n  font-weight: 600;\n  color: var(--color-primary);\n  font-size: 1rem;\n  letter-spacing: 0.5px;\n}\n.profile-info .qr-code-section {\n  margin: 1rem 0;\n  padding: 1rem 0;\n  border-top: 1px solid var(--color-border);\n}\n.profile-info .qr-code-section .qr-code-display {\n  margin-top: 1rem;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 1.5rem;\n  background: var(--color-bg);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--color-border);\n}\n.profile-info .qr-code-section .qr-code-display .qr-code-image {\n  width: 200px;\n  height: 200px;\n  border: 4px solid var(--color-bg-card);\n  border-radius: var(--radius);\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n  background: var(--color-bg-card);\n  padding: 8px;\n}\n.profile-info .qr-code-section .qr-code-display .qr-code-label {\n  margin: 0;\n  font-size: 0.875rem;\n  color: var(--color-text-muted);\n  text-align: center;\n  max-width: 300px;\n}\n.edit-link {\n  font-size: 0.875rem;\n  margin-left: 8px;\n}\n.edit-inline {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n  margin-left: 4px;\n}\n.edit-inline .edit-inline__input {\n  min-width: 180px;\n  padding: 6px 10px;\n  font-size: 0.9375rem;\n}\n.muted {\n  color: var(--color-text-muted);\n  margin: 0;\n}\n.household-info {\n  margin-bottom: 1rem;\n}\n.household-info .household-header {\n  margin-bottom: 1rem;\n}\n.household-info .household-header .household-title {\n  font-size: 1.125rem;\n  font-weight: 600;\n  margin: 0;\n  color: var(--color-text);\n}\n.household-info .household-details {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 1rem;\n}\n.household-info .household-details .detail-row {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.household-info .household-details .detail-row .detail-label {\n  font-size: 0.875rem;\n  color: var(--color-text-muted);\n  font-weight: 500;\n}\n.household-info .household-details .detail-row .detail-value {\n  font-size: 0.9375rem;\n  color: var(--color-text);\n}\n.household-members .section-header {\n  margin-bottom: 1rem;\n}\n.household-members .section-header .section-title {\n  font-size: 1.125rem;\n  font-weight: 600;\n  margin: 0;\n  color: var(--color-text);\n}\n.household-members .table-wrap {\n  overflow-x: auto;\n}\n.generate-cert-overlay {\n  position: fixed;\n  inset: 0;\n  background:\n    radial-gradient(\n      circle at top,\n      rgba(15, 23, 42, 0.55),\n      rgba(15, 23, 42, 0.9));\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1200;\n  padding: 1rem;\n  backdrop-filter: blur(6px);\n  -webkit-backdrop-filter: blur(6px);\n}\n.generate-cert-modal {\n  max-width: 460px;\n  width: 100%;\n  max-height: 90vh;\n  overflow: auto;\n  background: var(--color-bg-card);\n  border-radius: var(--radius-lg);\n  box-shadow: 0 24px 60px rgba(15, 23, 42, 0.35);\n  border: 1px solid color-mix(in srgb, var(--color-border) 70%, transparent);\n  transform-origin: center;\n  animation: modal-scale-in 0.16s ease-out;\n}\n.generate-cert-modal .modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1rem 1.5rem;\n  border-bottom: 1px solid rgba(15, 23, 42, 0.18);\n  background: var(--color-primary);\n}\n.generate-cert-modal .modal-title {\n  margin: 0;\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #f9fafb;\n}\n.generate-cert-modal .modal-close {\n  background: none;\n  border: none;\n  font-size: 1.5rem;\n  line-height: 1;\n  color: #e5e7eb;\n  cursor: pointer;\n  padding: 0.25rem;\n  border-radius: var(--radius);\n}\n.generate-cert-modal .modal-close:hover {\n  color: #ffffff;\n  background: rgba(15, 23, 42, 0.22);\n}\n.generate-cert-modal .modal-body {\n  padding: 1.25rem 1.5rem 1.5rem;\n}\n.generate-cert-modal .modal-body .form-group {\n  margin-bottom: 1rem;\n}\n.generate-cert-modal .modal-body .form-group label {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n  font-weight: 500;\n  font-size: 0.9rem;\n  color: var(--color-text);\n  margin-bottom: 0.4rem;\n}\n.generate-cert-modal .modal-body .form-group .form-control {\n  border-radius: 0.6rem;\n  border-color: color-mix(in srgb, var(--color-border) 80%, transparent);\n  transition:\n    box-shadow 0.15s ease,\n    border-color 0.15s ease,\n    background-color 0.15s ease;\n}\n.generate-cert-modal .modal-body .form-group .form-control:focus {\n  border-color: color-mix(in srgb, var(--color-primary) 75%, var(--color-border));\n  box-shadow: 0 0 0 1px color-mix(in srgb, var(--color-primary) 55%, transparent);\n  background-color: color-mix(in srgb, var(--color-bg) 90%, var(--color-primary) 4%);\n}\n.generate-cert-modal .modal-desc {\n  margin: 0 0 1rem;\n  font-size: 0.9375rem;\n  color: var(--color-text-muted);\n}\n.modal-actions {\n  display: flex;\n  gap: 0.75rem;\n  margin-top: 1.25rem;\n  flex-wrap: wrap;\n  justify-content: flex-end;\n}\n.success-msg {\n  color: var(--color-success, #22c55e);\n  font-weight: 500;\n  margin: 0 0 1rem;\n}\n.generate-certificate-footer {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 2rem 1rem;\n  margin-top: 2rem;\n  border-top: 1px solid var(--color-border);\n}\n@keyframes modal-scale-in {\n  from {\n    opacity: 0;\n    transform: translateY(8px) scale(0.97);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0) scale(1);\n  }\n}\n@media (max-width: 480px) {\n  .modal {\n    max-width: 100%;\n  }\n  .modal-actions {\n    width: 100%;\n    flex-direction: column-reverse;\n  }\n  .modal-actions .btn {\n    width: 100%;\n    justify-content: center;\n  }\n}\n/*# sourceMappingURL=resident-profile.component.css.map */\n'] }]
  }], () => [{ type: ActivatedRoute }, { type: Router }, { type: DataService }, { type: QrCodeService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResidentProfileComponent, { className: "ResidentProfileComponent", filePath: "src/app/pages/resident-profile/resident-profile.component.ts", lineNumber: 17 });
})();
export {
  ResidentProfileComponent
};
//# sourceMappingURL=chunk-NELCDWUM.js.map
