...
var _c2 = (a0) => ({ exact: a0 });
var _c3 = () => ["/resident/profile"];
var _c4 = () => ["/resident/settings"];
...
function ResidentLayoutComponent_Conditional_23_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, " My Profile ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "a", 52);
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Conditional_13_Template_a_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.closeProfileMenu());
    });
    ...
    \u0275\u0275listener("click", function ResidentLayoutComponent_Conditional_23_Conditional_13_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.logout();
      return \u0275\u0275resetView(ctx_r1.closeProfileMenu());
...
function ResidentLayoutComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, ResidentLayoutComponent_Conditional_23_Conditional_13_Template, 13, 4, "div", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_8_0;
...
function ResidentLayoutComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 18)(1, "span", 55);
    \u0275\u0275text(2, "+");
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResidentLayoutComponent, selectors: [["app-resident-layout"]], viewQuery: function ResidentLayoutComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(24, ResidentLayoutComponent_Conditional_24_Template, 5, 3, "a", 18);
      ...
      <div class="profile-menu" #profileMenu>\r
        ...
        @if (isProfileMenuOpen) {\r
          <div class="profile-menu__dropdown">\r
            <a [routerLink]="['/resident/profile']" class="profile-menu__item" (click)="closeProfileMenu()">\r
...
//# sourceMappingURL=chunk-5ROFJ6O2.js.map
