...
function MyRequestsComponent_Conditional_66_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c0, r_r1.id));
    \u0275\u0275advance(2);
...
function MyRequestsComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, MyRequestsComponent_Conditional_66_For_1_Template, 18, 10, "a", 28, _forTrack0);
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-UXTK4FCR.js.map
