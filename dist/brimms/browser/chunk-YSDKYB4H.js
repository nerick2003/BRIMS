...
function QrScannerComponent_Conditional_11_Conditional_10_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 43);
    \u0275\u0275listener("click", function QrScannerComponent_Conditional_11_Conditional_10_Conditional_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openPendingRoute());
    });
    \u0275\u0275text(1, " Open record in new tab ");
    \u0275\u0275elementEnd();
  }
}
function QrScannerComponent_Conditional_11_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, QrScannerComponent_Conditional_11_Conditional_10_Conditional_2_Template, 2, 0, "button", 42);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.scanError);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.pendingRoute ? 2 : -1);
  }
}
function QrScannerComponent_Conditional_11_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.scanResultLabel || "Opening record\u2026");
  }
}
function QrScannerComponent_Conditional_11_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.scanResultLabel);
  }
}
function QrScannerComponent_Conditional_11_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1, "Processing\u2026");
    \u0275\u0275elementEnd();
...
function QrScannerComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, QrScannerComponent_Conditional_11_Conditional_9_Template, 6, 3)(10, QrScannerComponent_Conditional_11_Conditional_10_Template, 3, 2)(11, QrScannerComponent_Conditional_11_Conditional_11_Template, 2, 1, "p", 38)(12, QrScannerComponent_Conditional_11_Conditional_12_Template, 2, 1, "p", 38)(13, QrScannerComponent_Conditional_11_Conditional_13_Template, 2, 0, "p", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.scanResultUrl ? 9 : ctx_r1.scanError ? 10 : ctx_r1.isNavigating ? 11 : ctx_r1.scanResultLabel ? 12 : 13);
  }
}
var QrScannerComponent = class _QrScannerComponent {
  ...
  openResident(base, residentKey) {
    ...
    this.scanResultLabel = resident ? `Opening profile for ${resident.name} in a new tab\u2026` : "Opening resident profile in a new tab\u2026";
    this.openRouteInNewTab([base, "residents", routeId]);
  }
  openRequest(base, requestId) {
    ...
    this.scanResultLabel = request ? `Opening request ${request.id} in a new tab\u2026` : "Opening request in a new tab\u2026";
  ...
  processScannedCode(code) {
    try {
      ...
      const residentFromId = this.data.getResidentById(trimmedCode) || this.data.getResidentByResidentId(trimmedCode);
      if (residentFromId) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QrScannerComponent, selectors: [["app-qr-scanner"]], decls: 12, vars: 3, consts: [[1, "qr-scanner"], [1, "page-header"], [1, "page-title"], ["routerLink", "../dashboard", 1, "back-button"], [1, "back-button__icon"], [1, "back-button__text"], [1, "permission-card", "card"], [1, "scanner-container"], [1, "scan-result", "card"], [1, "permission-icon"], [1, "permission-hint"], [1, "permission-tip"], ["type", "button", 1, "btn", "btn--primary", 3, "click"], [1, "scanner-wrapper"], [1, "scanner", 3, "torchCompatible", "camerasFound", "scanSuccess", "scanError", "enable", "device", "formats", "torch"], [1, "scanner-overlay"], [1, "scanner-frame"], [1, "scanner-frame__corners"], [1, "corner", "corner--top-left"], [1, "corner", "corner--top-right"], [1, "corner", "corner--bottom-left"], [1, "corner", "corner--bottom-right"], [1, "scanner-instruction"], [1, "scanner-instruction__icon"], [1, "scanner-controls"], [1, "scanner-controls__row"], [1, "control-group"], ["type", "button", 1, "btn", "btn--secondary", "btn--icon"], ["for", "camera-select"], [1, "control-label__icon"], ["id", "camera-select", 1, "form-control", 3, "change", "value"], [3, "value"], ["type", "button", 1, "btn", "btn--secondary", "btn--icon", 3, "click"], [1, "btn-icon"], [1, "scan-result__header"], ["type", "button", 1, "btn", "btn--sm", "btn--secondary", 3, "click"], [1, "scan-result__content"], [1, "scan-result__code"], [1, "scan-result__success"], ["target", "_blank", "rel", "noopener noreferrer", 3, "href"], ["target", "_blank", "rel", "noopener noreferrer", 1, "btn", "btn--primary", "btn--sm", 3, "href"], [1, "scan-result__error"], ["type", "button", 1, "btn", "btn--primary", "btn--sm"], ["type", "button", 1, "btn", "btn--primary", "btn--sm", 3, "click"]], template: function QrScannerComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(11, QrScannerComponent_Conditional_11_Template, 14, 2, "div", 8);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(9);
      ...
      <div class="scan-result__content">\r
        ...
        @if (scanResultUrl) {\r
          <p class="scan-result__success">\r
            ...
            <a [href]="scanResultUrl" target="_blank" rel="noopener noreferrer">\r
              {{ scanResultUrl }}\r
            </a>\r
          </p>\r
          <a\r
          ...
          @if (pendingRoute) {\r
            <button\r
              type="button"\r
              class="btn btn--primary btn--sm"\r
              (click)="openPendingRoute()"\r
            >\r
              Open record in new tab\r
            </button>\r
          }\r
        } @else if (isNavigating) {\r
          <p class="scan-result__success">{{ scanResultLabel || 'Opening record\u2026' }}</p>\r
        } @else if (scanResultLabel) {\r
          <p class="scan-result__success">{{ scanResultLabel }}</p>\r
        } @else {\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QrScannerComponent, { className: "QrScannerComponent", filePath: "src/app/pages/qr-scanner/qr-scanner.component.ts", lineNumber: 21 });
})();
export {
  QrScannerComponent
};
//# sourceMappingURL=chunk-YSDKYB4H.js.map
