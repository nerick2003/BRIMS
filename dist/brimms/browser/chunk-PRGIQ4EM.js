...
function StaffLayoutComponent_For_12_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function StaffLayoutComponent_For_12_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function StaffLayoutComponent_For_12_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
    \u0275\u0275element(1, "path", 47);
...
function StaffLayoutComponent_For_12_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 28);
...
function StaffLayoutComponent_For_12_Case_13_Template(rf, ctx) {
  if (rf & 1) {
...
function StaffLayoutComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 25);
    \u0275\u0275listener("click", function StaffLayoutComponent_For_12_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeMobileMenu());
    });
    \u0275\u0275elementStart(1, "span", 26);
    \u0275\u0275conditionalCreate(2, StaffLayoutComponent_For_12_Case_2_Template, 5, 0, ":svg:svg", 27)(3, StaffLayoutComponent_For_12_Case_3_Template, 3, 0, ":svg:svg", 28)(4, StaffLayoutComponent_For_12_Case_4_Template, 3, 0, ":svg:svg", 28)(5, StaffLayoutComponent_For_12_Case_5_Template, 3, 0, ":svg:svg", 28)(6, StaffLayoutComponent_For_12_Case_6_Template, 5, 0, ":svg:svg", 28)(7, StaffLayoutComponent_For_12_Case_7_Template, 4, 0, ":svg:svg", 28)(8, StaffLayoutComponent_For_12_Case_8_Template, 2, 0, ":svg:svg", 28)(9, StaffLayoutComponent_For_12_Case_9_Template, 5, 0, ":svg:svg", 28)(10, StaffLayoutComponent_For_12_Case_10_Template, 3, 0, ":svg:svg", 28)(11, StaffLayoutComponent_For_12_Case_11_Template, 3, 0, ":svg:svg", 28)(12, StaffLayoutComponent_For_12_Case_12_Template, 4, 0, ":svg:svg", 28)(13, StaffLayoutComponent_For_12_Case_13_Template, 2, 0, "span", 29);
    \u0275\u0275elementEnd();
...
function StaffLayoutComponent_Conditional_25_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function StaffLayoutComponent_Conditional_25_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 61);
    \u0275\u0275element(1, "path", 70);
...
function StaffLayoutComponent_Conditional_25_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 62);
  }
}
function StaffLayoutComponent_Conditional_25_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 65);
  }
  if (rf & 2) {
...
function StaffLayoutComponent_Conditional_25_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function StaffLayoutComponent_Conditional_25_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 67)(1, "a", 71);
    \u0275\u0275listener("click", function StaffLayoutComponent_Conditional_25_Conditional_13_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r7);
    ...
    \u0275\u0275listener("click", function StaffLayoutComponent_Conditional_25_Conditional_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.logout();
      return \u0275\u0275resetView(ctx_r1.closeProfileMenu());
...
function StaffLayoutComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function StaffLayoutComponent_Conditional_25_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.theme.toggleTheme());
    });
    \u0275\u0275conditionalCreate(4, StaffLayoutComponent_Conditional_25_Conditional_4_Template, 3, 0, ":svg:svg", 61)(5, StaffLayoutComponent_Conditional_25_Conditional_5_Template, 2, 0, ":svg:svg", 61);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, StaffLayoutComponent_Conditional_25_Conditional_6_Template, 1, 0, "div", 62);
    \u0275\u0275elementStart(7, "div", 63, 1)(9, "button", 64);
    \u0275\u0275listener("click", function StaffLayoutComponent_Conditional_25_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleProfileMenu());
    });
    \u0275\u0275conditionalCreate(10, StaffLayoutComponent_Conditional_25_Conditional_10_Template, 1, 1, "img", 65);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275conditionalBranchCreate(12, StaffLayoutComponent_Conditional_25_Conditional_12_Template, 2, 0, "span", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, StaffLayoutComponent_Conditional_25_Conditional_13_Template, 9, 2, "div", 67);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_9_0;
...
function StaffLayoutComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
...
function StaffLayoutComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 77);
    \u0275\u0275listener("click", function StaffLayoutComponent_Conditional_27_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
...
var StaffLayoutComponent = class _StaffLayoutComponent {
  ...
  get showMobileMenuToggle() {
    ...
    if (path.startsWith("/staff/households/map"))
      return false;
    if (this.isHouseholdDetailPath(path))
      return false;
    if (/^\/staff\/households\/[^/]+\/?$/.test(path))
      return false;
    if (/^\/staff\/residents\/[^/]+$/.test(path))
      return false;
    if (path.startsWith("/staff/requests/") && path !== "/staff/requests")
      return false;
  ...
  /** Hide profile + theme toggle on forms, resident profile, request detail, and edit household */
  get showTopRightUi() {
    const path = this.currentPath;
    if (path.startsWith("/staff/households/map"))
      return false;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffLayoutComponent, selectors: [["app-staff-layout"]], viewQuery: function StaffLayoutComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function StaffLayoutComponent_Template_button_click_8_listener() {
          return ctx.closeMobileMenu();
        });
        \u0275\u0275text(9, " \u2715 ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(10, "nav", 11);
        \u0275\u0275repeaterCreate(11, StaffLayoutComponent_For_12_Template, 16, 6, "a", 12, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("scroll", function StaffLayoutComponent_Template_main_scroll_22_listener() {
          return ctx.onContentScroll();
        });
        \u0275\u0275element(24, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(25, StaffLayoutComponent_Conditional_25_Template, 14, 11, "header", 19);
        \u0275\u0275conditionalCreate(26, StaffLayoutComponent_Conditional_26_Template, 5, 5, "a", 20);
        \u0275\u0275conditionalCreate(27, StaffLayoutComponent_Conditional_27_Template, 3, 2, "button", 21);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_10_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaffLayoutComponent, [{
    type: Component,
    args: [{ selector: "app-staff-layout", standalone: true, imports: [CommonModule, RouterOutlet, RouterLink, RouterLinkActive, DatePipe, LogoTiltDirective], template: `<div class="staff-layout" [class.staff-layout--no-top-bar]="!showTopRightUi">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffLayoutComponent, { className: "StaffLayoutComponent", filePath: "src/app/layouts/staff-layout/staff-layout.component.ts", lineNumber: 18 });
})();
export {
  StaffLayoutComponent
};
//# sourceMappingURL=chunk-PRGIQ4EM.js.map
