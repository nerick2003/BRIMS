...
var AddResidentComponent = class _AddResidentComponent {
  ...
  submit() {
    ...
    if (this.data.isDuplicateResident({
      name: fullName,
      birthdate: this.resident.birthdate || void 0,
      birthCertificateNumber: this.resident.birthCertificateNumber || void 0
    })) {
      this.error = "A resident with the same name and birthdate, or the same birth certificate (BC) number, already exists.";
      return;
    }
    const newResident = {
      id: nextId,
...
//# sourceMappingURL=chunk-R4Q2LOEE.js.map
