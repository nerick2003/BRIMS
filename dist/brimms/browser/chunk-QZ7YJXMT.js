...
function AdminLayoutComponent_Conditional_23_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminLayoutComponent_Conditional_23_Conditional_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.logout();
      return \u0275\u0275resetView(ctx_r1.closeProfileMenu());
...
function AdminLayoutComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, AdminLayoutComponent_Conditional_23_Conditional_13_Template, 9, 2, "div", 65);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_8_0;
...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  get showMobileMenuToggle() {
    ...
    if (url.startsWith("/admin/households/map"))
      return false;
    if (/^\/admin\/residents\/[^/]+$/.test(url))
      return false;
    if (url.startsWith("/admin/requests/") && url !== "/admin/requests")
      return false;
    if (url.includes("/qr-scanner"))
      return false;
    if (url.includes("/residents/add"))
      return false;
    if (url.includes("/households/add"))
      return false;
    return true;
  }
  /**
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], viewQuery: function AdminLayoutComponent_Query(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.showBackToTop && !ctx.isMobileMenuOpen ? 25 : -1);
      }
...
//# sourceMappingURL=chunk-QZ7YJXMT.js.map
