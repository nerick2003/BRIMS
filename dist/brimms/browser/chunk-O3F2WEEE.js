...
function ResidentRequestDetailComponent_Conditional_1_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 26)(1, "h2", 30);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 32, 0)(7, "header", 33)(8, "div", 34);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "main", 40)(20, "h1", 41);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "p", 42);
    \u0275\u0275text(23, " TO WHOM IT MAY CONCERN: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "p", 43);
    ...
    \u0275\u0275text(36, ". ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "p", 43);
    \u0275\u0275text(38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 45)(40, "div", 46)(41, "span", 47);
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(49, "div", 27)(50, "button", 52);
    \u0275\u0275listener("click", function ResidentRequestDetailComponent_Conditional_1_Conditional_49_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function ResidentRequestDetailComponent_Conditional_1_Conditional_49_Template_button_click_55_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(60, "a", 55)(61, "span", 53);
    \u0275\u0275text(62, "+");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate((ctx_r1.resident == null ? null : ctx_r1.resident.name) || "____________________");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(", of legal age, ", (ctx_r1.resident == null ? null : ctx_r1.resident.civilStatus) || "single/married", ", and a resident of ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ctx_r1.resident == null ? null : ctx_r1.resident.address) || "Purok " + ((ctx_r1.resident == null ? null : ctx_r1.resident.purok) || "___") + ", Barangay Name, Municipality of Villanueva, Province of Misamis Oriental");
    \u0275\u0275advance(5);
...
function ResidentRequestDetailComponent_Conditional_1_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27)(1, "a", 55)(2, "span", 53);
    \u0275\u0275text(3, "+");
    \u0275\u0275elementEnd();
...
function ResidentRequestDetailComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(45);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(46, ResidentRequestDetailComponent_Conditional_1_Conditional_46_Template, 8, 0, "div", 23);
    \u0275\u0275conditionalCreate(47, ResidentRequestDetailComponent_Conditional_1_Conditional_47_Template, 8, 0, "div", 24);
    \u0275\u0275conditionalCreate(48, ResidentRequestDetailComponent_Conditional_1_Conditional_48_Template, 8, 0, "div", 25);
    \u0275\u0275conditionalCreate(49, ResidentRequestDetailComponent_Conditional_1_Conditional_49_Template, 65, 7, "section", 26)(50, ResidentRequestDetailComponent_Conditional_1_Conditional_50_Template, 6, 0, "div", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("ID: ", ctx_r1.request.id);
    \u0275\u0275advance(7);
    \u0275\u0275property("ngClass", "status-card--" + ctx_r1.request.status.toLowerCase().replace(" ", "-"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.getStatusIcon(ctx_r1.request.status));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ctx_r1.getStatusBadgeClass(ctx_r1.request.status));
    \u0275\u0275advance();
    ...
    \u0275\u0275textInterpolate(ctx_r1.request.id);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.request.status === "Pending" ? 46 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.request.status === "For Review" ? 47 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.request.status === "Approved" ? 48 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.canDownload() ? 49 : 50);
  }
}
function ResidentRequestDetailComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 56)(2, "div", 57);
    \u0275\u0275text(3, "\u274C");
    \u0275\u0275elementEnd();
...
var ResidentRequestDetailComponent = class _ResidentRequestDetailComponent {
  ...
  static {
    ...
    }, decls: 3, vars: 1, consts: [["certificateRef", ""], [1, "resident-request-detail"], [1, "card"], [1, "request-header"], [1, "request-header__title"], [1, "page-title"], [1, "request-id"], ["routerLink", "/resident/requests", 1, "back-button"], [1, "back-button__icon"], [1, "back-button__text"], [1, "request-info"], [1, "status-card", 3, "ngClass"], [1, "status-card__icon"], [1, "status-card__content"], [1, "status-card__label"], [1, "status-card__value"], [1, "badge", 3, "ngClass"], [1, "info-section"], [1, "info-grid"], [1, "info-item"], [1, "info-label"], [1, "info-value"], [1, "info-value", "info-value--mono"], [1, "status-message", "status-message--info"], [1, "status-message", "status-message--warning"], [1, "status-message", "status-message--success"], ["aria-label", "Certificate preview", 1, "certificate-section"], [1, "action-section"], [1, "status-message__icon"], [1, "status-message__content"], [1, "certificate-section__title"], [1, "certificate-section__hint"], [1, "certificate", "certificate--barangay"], [1, "certificate__header"], [1, "certificate__republic"], [1, "certificate__province"], [1, "certificate__municipality"], [1, "certificate__barangay"], [1, "certificate__line"], [1, "certificate__office"], [1, "certificate__body"], [1, "certificate__title"], [1, "certificate__intro"], [1, "certificate__paragraph"], [1, "certificate__highlight"], [1, "certificate__footer"], [1, "certificate__control"], [1, "certificate__control-label"], [1, "certificate__control-value"], [1, "certificate__signature-block"], [1, "certificate__signature-line"], [1, "certificate__signature-name"], ["type", "button", 1, "btn", "btn--success", "btn--lg", 3, "click"], [1, "btn-icon"], ["type", "button", 1, "btn", "btn--outline", "btn--lg", 3, "click"], ["routerLink", "/resident/request-certificate", 1, "btn", "btn--primary", "btn--lg"], [1, "error-state"], [1, "error-state__icon"], [1, "muted"]], template: function ResidentRequestDetailComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1);
        \u0275\u0275conditionalCreate(1, ResidentRequestDetailComponent_Conditional_1_Template, 51, 13, "div", 2)(2, ResidentRequestDetailComponent_Conditional_2_Template, 13, 0, "div", 2);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-O3F2WEEE.js.map
